...
namespace BlackPearl {
	...
	void MeshRenderer::SetTexture(unsigned int meshIndex, const std::shared_ptr<ITexture>& texture) {
	...
	void MeshRenderer::SetTextures(const std::shared_ptr<ITexture>& texture)
	{
