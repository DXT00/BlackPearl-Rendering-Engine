...
namespace BlackPearl {
	...
	LightProbe::LightProbe(Object* cubeObj)
	{
		...
		m_DiffuseIrradianceCubeMap.reset(DBG_NEW CubeMapTexture(Texture::CubeMap, m_DiffuseCubeMapResolution, m_DiffuseCubeMapResolution, GL_LINEAR, GL_LINEAR, GL_CLAMP_TO_EDGE, GL_RGB16F, GL_RGB, GL_FLOAT, false));
	...
	{
		m_Size = size;
		m_CubeObj->GetComponent<Transform>()->SetScale(size);
	}
