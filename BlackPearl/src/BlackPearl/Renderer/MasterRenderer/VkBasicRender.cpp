...
namespace BlackPearl {
    ...
    SwapChainSupportDetails VkBasicRender::_QuerySwapChainSupport(VkPhysicalDevice device) {
     ...
     *
     */
    QueueFamilyIndices VkBasicRender::FindQueueFamilies(const VkPhysicalDevice& device)
    {
