...
//
//DECLARE_MULTICAST_DELEGATE_ThreeParams(FOnSafetyNetAttestationResult, bool, const FString&, int32_t);
//
...
// Define all the Java classes/methods that the game will need to access to
    ...
    public:
         ...
         */
        static jclass FindClass(JNIEnv *Env, const char *ClassName, bool bIsOptional);

        static jclass FindClassGlobalRef(JNIEnv *Env, const char *ClassName, bool bIsOptional);

        static jmethodID
        FindMethod(JNIEnv *Env, jclass Class, const char *MethodName, const char *MethodSignature, bool bIsOptional);

        static jmethodID
        FindStaticMethod(JNIEnv *Env, jclass Class, const char *MethodName, const char *MethodSignature,
                         bool bIsOptional);

        static jfieldID
        FindField(JNIEnv *Env, jclass Class, const char *FieldName, const char *FieldType, bool bIsOptional);
        ...
        static int64_t CallLongMethod(JNIEnv *Env, jobject Object, jmethodID Method, ...);
