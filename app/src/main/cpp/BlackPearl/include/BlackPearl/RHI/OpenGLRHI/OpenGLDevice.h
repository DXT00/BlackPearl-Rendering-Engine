...
#define GL_TEXTURE_EXTERNAL_OES 0x8D65
	...
	public:
        ...
        //Threads
        virtual void acquireThreadOwnership() final override;
        virtual void releaseThreadOwnership() final override;
...
//FPlatformOpenGLDevice* m_PlatformDevice = nullptr;
	...
	protected:
		...
		private:
			 ...
			 */
			FOpenGLLinkedProgram* LinkProgram(const FOpenGLLinkedProgramConfiguration& config, Shader* vertexShader, Shader* pixelShader, Shader* geometryShader, Shader* computeShader);
