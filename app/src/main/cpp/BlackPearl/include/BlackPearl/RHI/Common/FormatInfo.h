...
namespace BlackPearl
{
    ...
    static const FormatInfo c_FormatInfo[] = {
        //        format                   name             bytes blk         kind               red   green   blue  alpha  depth  stencl signed  srgb
            ...
            { Format::D24,               "D24",               3,   1, FormatKind::DepthStencil, false, false, false, false, true,  false, false, false },
            ...
            { Format::D32_FLOAT,         "D32_FLOAT",         4,   1, FormatKind::DepthStencil, false, false, false, false, true,  false, false, false },
