...
/*=============================================================================
    ...
    注意， OpenGL.h不能被单独include， 需改为 include OpenGLDrv.h，根据平台来选择实际的gl版本

    Note that OpenGL.h cannot be included separately.
    It needs to be changed to include OpenGLDrv.h.
    Select the actual gl version based on the platform
=============================================================================*/
#pragma once
#include <stdint.h>
#include <string>
...
#define UGL_REQUIRED_VOID			{ GE_ASSERT(0, "gl function is not supported."); }
#define UGL_REQUIRED(ReturnValue)	{ GE_ASSERT(0, "gl function is not supported."); return (ReturnValue); }
#define UGL_OPTIONAL_VOID			{ }
#define UGL_OPTIONAL(ReturnValue)	{ return (ReturnValue); }
struct FPlatformOpenGLDevice;
struct FPlatformOpenGLContext;
