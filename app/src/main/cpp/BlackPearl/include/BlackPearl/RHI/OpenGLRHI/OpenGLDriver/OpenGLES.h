...
#ifndef GE_PLATFORM_WINDOWS // need this to fix compile issues with Win configuration.
...
struct FOpenGLES : public FOpenGLBase
{
	...
	static FORCEINLINE void FramebufferTexture2D(GLenum Target, GLenum Attachment, GLenum TexTarget, GLuint Texture, GLint Level)
	{
		...
		GE_ASSERT(FramebufferTexture_2D);
	}
...
public:
	...
	enum class EFeatureLevelSupport : uint8_t
	{
