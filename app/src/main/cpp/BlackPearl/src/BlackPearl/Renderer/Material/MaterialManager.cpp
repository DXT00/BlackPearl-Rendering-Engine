...
//                
//                systemTextures.GBufferA = device->createTexture(gBufferTextureDesc);
//            }
//            else if (gBufferInfo.targets[i].name == "GBufferB") {
//                systemTextures.GBufferB = device->createTexture(gBufferTextureDesc);
//
//            }
//            else if (gBufferInfo.targets[i].name == "GBufferC") {
//                systemTextures.GBufferC = device->createTexture(gBufferTextureDesc);
//
//            }
//            else if (gBufferInfo.targets[i].name == "SceneColor") {
//                systemTextures.SceneColor = device->createTexture(gBufferTextureDesc);
//
//            }
//
//           
