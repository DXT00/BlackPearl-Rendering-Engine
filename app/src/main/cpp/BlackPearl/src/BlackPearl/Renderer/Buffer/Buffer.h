...
namespace BlackPearl {
	...
	struct BufferElement {
		...
		uint32_t  GetElementCount() const{
            ...
            case ElementDataType::Char:      return 1;
            case ElementDataType::Char3:      return 3;
	...
	public:
        ...
        void SetElementLocation(uint32_t i, uint32_t location){
            if(i < m_Elememts.size())
            {
                m_Elememts[i].Location = location;
            }
        }
