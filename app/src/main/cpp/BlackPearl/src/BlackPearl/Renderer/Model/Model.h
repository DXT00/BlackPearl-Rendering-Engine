...
namespace BlackPearl {
	...
	public:
		...
		[[nodiscard]] std::vector<std::shared_ptr<Mesh>>  GetMeshes() const { return m_Meshes; }
		...
		[[nodiscard]] std::vector<Vertex>		GetMeshVertex() const { return m_Vertices; }
		...
		[[nodiscard]] std::shared_ptr<AABB> GetAABB() const { return m_AABB; }
	public:
