...
namespace BlackPearl {
	...
	public:
		struct WindowData {
			...
			unsigned int Height;
			unsigned int Width;
			WindowData(const std::string& title = "BlackPearl", unsigned int width = Configuration::WindowWidth, unsigned int height = Configuration::WindowHeight)//1920��1080 ��Ӧ��PerspeciveCamera projectionMatrixҲҪ��
