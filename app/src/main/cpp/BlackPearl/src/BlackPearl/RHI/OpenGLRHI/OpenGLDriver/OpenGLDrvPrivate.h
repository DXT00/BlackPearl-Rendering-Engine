...
enum EOpenGLCurrentContext : int8_t
{
	CONTEXT_Other = -2,
	CONTEXT_Invalid = -1,
	CONTEXT_Shared = 0,
...
inline void FindPrimitiveType(uint32_t InPrimitiveType, uint32_t InNumPrimitives, GLenum &DrawMode, GLsizei &NumElements)
{
...
inline uint32_t FindUniformElementSize(GLenum UniformType)
{
	switch (UniformType)
	{
	case GL_FLOAT:
