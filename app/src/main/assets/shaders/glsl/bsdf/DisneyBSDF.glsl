...
vec3 evaluateDisneyBRDF(DisneyMaterialConstant mat, SurfaceGeometry geom, vec3 lightDir) {
...
vec4 ShadeSurface(in LightConstants light, in SurfaceGeometry geom, in DisneyMaterialConstant material){
