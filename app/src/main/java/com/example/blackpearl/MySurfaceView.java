...
public class MySurfaceView extends GLSurfaceView implements ScaleGestureDetector.OnScaleGestureListener {
    ...
    private SandBoxAndriodRender mGLRender;
...
//        SandBoxAndriodRender = new MyGLRender();
//        /*If no setEGLConfigChooser method is called,
//        then by default the view will choose an RGB_888 surface with a depth buffer depth of at least 16 bits.*/
//        setEGLConfigChooser(8, 8, 8, 8, 16, 8);
//        setRenderer(SandBoxAndriodRender);
//        setRenderMode(RENDERMODE_WHEN_DIRTY);
//        mScaleGestureDetector = new ScaleGestureDetector(context, this);
//
//    }

    public MySurfaceView(Context context, SandBoxAndriodRender glRender) {
        this(context, glRender, null);
    }

    public MySurfaceView(Context context, SandBoxAndriodRender glRender, AttributeSet attrs) {
        super(context, attrs);
        this.setEGLContextClientVersion(2);
        mGLRender = glRender;
        /*If no setEGLConfigChooser method is called,
...
//                        break;
    ...
    public SandBoxAndriodRender getGLRender() {
        return mGLRender;
    }
