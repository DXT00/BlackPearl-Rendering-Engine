...
struct PrimitiveInstanceConstantBuffer
{
    ...
    unsigned int primitiveType; // Procedural primitive type
};
...
{
    static const unsigned int InstanceMask = ~0;   // Everything is visible.
    namespace HitGroup {
        static const unsigned int Offset[RayType::Count] =
        {
            0, // Radiance ray
            1  // Shadow ray
        };
        static const unsigned int GeometryStride = RayType::Count;
    }
...
static const XMFLOAT4 BackgroundColor = XMFLOAT4(0.8f, 0.9f, 0.1f, 1.0f); ;// XMFLOAT4(0.8f, 0.9f, 1.0f, 1.0f);
